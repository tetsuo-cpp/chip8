...
SRCS=src/main.cc lib/chip8.cc lib/cpu.cc lib/rom.cc lib/display.cc
...
chip8.o: lib/chip8.h lib/chip8.cc lib/cpu.h lib/rom.h lib/display.cc

cpu.o: lib/cpu.h lib/cpu.cc lib/rom.h lib/display.cc
